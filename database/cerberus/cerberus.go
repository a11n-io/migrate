...
func (m *Cerberus) ensureVersionTable() (err error) {
...
func (m *Cerberus) executeQueryNoTx(query string) error {
	if _, err := m.db.Exec(query); err != nil {
		return &database.Error{OrigErr: err, Query: []byte(query)}
	}
	return nil
...
func (m *Cerberus) Version() (version int, dirty bool, err error) {
